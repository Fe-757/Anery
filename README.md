# Anery
Anery é uma linguagem de programação simples em português, focado para iniciantes e devs que não querem ter dor de cabeça.
Está em fase bem inicial, pretendo expandir bem mais essa linguagem
...
3) Console: baixe o arquivo anery-console.js > abra a pasta no powershell no windows ou o console na sua distro Linux > rode node anery-console.js > agora você pode testar códigos Anery direto pelo console
